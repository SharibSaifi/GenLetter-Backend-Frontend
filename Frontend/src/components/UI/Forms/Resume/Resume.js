...
function Resume() {
    ...
    const resumeTypeSetter = (resumeType) => {
        const copy = { ...refs };
        resumeType == 'resume1' ? copy.singlePage = true : copy.singlePage = false;
        setRefs(copy);
    }
    ...
    switch (index) {
        ...
        case 7: content = (
            ...
            break;
        case 8: content = (
            <POR onChange={handleArrayChange} title='Positions of Responsibility'
                nextStep={nextStep} prevStep={prevStep}
                values={refs} increase={fieldArrayAddHandler} decrease={fieldRemoveHandler}
                increaseLink={linkIncreaseHandler} decreaseLink={linkDecreaseHandler}
                onChangeLink={handleLinkChange} />
        );
            break;
        case 9 : content = (
            <Select onChange={handleChange} title='Select Resume Type'
            nextStep={nextStep} prevStep={prevStep} formSubmitted={handleSubmit}
            values={refs} resumeTypeSetter={resumeTypeSetter}/>
        );
            break;
        default: content = (
